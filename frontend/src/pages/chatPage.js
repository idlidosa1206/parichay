...
const ChatPage = () => {
  ...
  const handleSendMessage = (text, sender) => {
    ...
    if (sender === "Anonmyous") {
      ...
      setTimeout(() => {
        ...
        const newMessageFromOtherUser = {
          text: randomText,
          sender: "Parichay helpline",
        };
  ...
  const getRandomText = () => {
    const texts = [
      ...
      "How can I help you? We believe in healing.",
  ...
  return (
    <div className="chat-container">
      {" "}
      {/* Wrap the chat component in a div with chat-container class */}
      <div className="chat-page">
        {" "}
        {/* Keep the chat-page class for styling */}
